...
Comparison of proportions within the target feature levels

```{r}
lev<-ggplot(ks_filt,aes(x=state))
...
a
might be more appropriate to show proportions within each state (because there are more failed than succcessful observations)
